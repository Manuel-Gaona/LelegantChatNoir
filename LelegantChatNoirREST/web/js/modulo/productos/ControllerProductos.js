            ...
            .then(data => {
                ...
                data.forEach(producto => {
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn btn-outline-warning btn-sm btn-editar" data-codigoProducto="${producto.codigoProducto}" data-bs-toggle="modal" data-bs-target="#Agregar"><i class="bi bi-pencil-square"></i></button>
