...
const templateTabla = (data) => {
    ...
    data.forEach(usuario => {
        ...
        let templateBotones = `
            <div class="btn-group">
                <button class="btn btn-outline-warning btn-sm btn-editar" data-id="${usuario.idUsuario}" data-bs-toggle="modal" data-bs-target="#Agregar"><i class="bi bi-pencil-square"></i></button>
...
const confirmacionEliminar = (id, data) => {
    // se busca el dato en el arreglo almacenado en data usando el id
    const producto = data.find(p => p.idProducto == id);
    ...
    .then(data => {
        ...
        btnEditar.forEach(btn => {
            btn.addEventListener('click', (event) => {
                ...
                // Se obtiene el id del boton de editar usando el atributo data-id del boton
                // se llama a la función cargarModalEditar para cargar el modal de editar venta
                cargarModalEditar(btn.getAttribute('data-id'));
            })
        });
...
// -----------------------------------------------------------------------------------------------------
// codigo para cargar el modal de editar
// -----------------------------------------------------------------------------------------------------
// funcion para cargar el modal de editar
const cargarModalEditar = (id) => {
